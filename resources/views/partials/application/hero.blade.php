...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <p class="subheader">Sudan Electronic Pad</p>
  </div>
    </div>
    ...
    <p class="subheader">We provide the public with the largest and most distinctive collection of e-readers, containing "books, newspapers and magazines" </p>
  </div>
    </div>
    <div class="carousel-item">
    ...
    <p class="subheader">We also provide writers and creators with the opportunity to produce, publish, market and sell their works through the library.</p>
      </div>
    </div>
    <div class="carousel-item">
